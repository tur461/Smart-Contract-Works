...
contract SteepServicePayableToken is IERC20 {
    ...
    constructor (string memory name_, string memory sym_, uint8 dec_){
        _name = name_;
        _symbol = sym_;
        _decimals = dec_;
        _owner = msg.sender;
    ...
    function balanceOf(address account_) public override view returns (uint256) {
        return _balances[account_];
    }
    
    function transfer(address recipient_, uint256 amount) public override returns (bool) {
